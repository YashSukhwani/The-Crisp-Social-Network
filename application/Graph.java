...
/**
 * Creates graph that manages user relationships to one another and also
 * provides a way to determine closest distance between friends as well as how
 * many groups of friends exist
 * 
 * @author Team 70
 *
 */
public class Graph implements GraphADT {
	...
	/**
	 * Method that could be used, but was decided not to be in favor of testing
	 * through the GraphTest class
	 *
	 * @param args
	 */
	...
	/**
	 * either vertex does not exist, or if an edge from vertex1 to vertex2 does not
